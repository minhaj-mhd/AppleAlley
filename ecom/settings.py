...
# Additional static directories to include (in addition to app-specific ones)
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Look for static files in the 'static' directory within the project
]
